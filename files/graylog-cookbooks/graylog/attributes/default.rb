...
default['graylog']['graylog-server']['elasticsearch_max_total_connections'] = 20
default['graylog']['graylog-server']['elasticsearch_max_total_connections_per_route'] = 2
default['graylog']['graylog-server']['elasticsearch_discovery_enabled'] = true
default['graylog']['graylog-server']['elasticsearch_discovery_frequency'] = "30s"
