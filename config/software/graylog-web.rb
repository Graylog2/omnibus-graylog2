...
if version.include? '-beta' or version.include? '-rc' or version.include? 'SNAPSHOT'
  ...
  source url: "https://packages.graylog2.org/nightly-builds/graylog-web-interface-1.3.0-SNAPSHOT-20151126182121.tgz",
         md5: "0bf2f519224594e3cf29eb9908b8a5ed"
else
  source url: "http://packages.graylog2.org/releases/graylog2-web-interface/graylog-web-interface-#{version}.tgz",
...
relative_path "graylog-web-interface-1.3.0-SNAPSHOT-20151126182121"
